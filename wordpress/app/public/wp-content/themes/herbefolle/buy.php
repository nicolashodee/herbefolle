  ...
  <main class="container">
    ...
    <section class="main-title">
      <div><h3>Pré-commandez vos plats ici !</h3></div>
      
      <h4 class="accent-color">Important: <br>Nous utilisons exclusivement des produits frais. Merci de nous contacter au plus tard la veille</h4>
    </section>
      ...
      <div class="buy__telephone">
        ...
        <div>
          <ul>
            ...
            <li>Mode de livraison souhaité (voir conditions)</li>
          </ul>
        </div>
